  ...
  // JoomlaWorks reference parameters
    ...
    if(JPluginHelper::isEnabled('content',$this->plg_name)==false) return;
		...
		if(JRequest::getCmd('format')=='html' || JRequest::getCmd('format')==''){
			...
			if($gzipScripts){
				$document->addScript($pluginLivePath.'/includes/js/jw_allvideos.js.php?v=4.5.1');
			} else {
				$document->addScript($pluginLivePath.'/includes/js/behaviour.js?v=4.5.1');
				$document->addScript($pluginLivePath.'/includes/js/mediaplayer/jwplayer.min.js?v=4.5.1');
